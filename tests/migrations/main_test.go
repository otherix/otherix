...
// shared is a process-global harness initialized by TestMain. All tests in
// this package use it — they each insert their own rows with unique keys, so
// shared state across tests is fine.

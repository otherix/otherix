...
echo "  make demo-manifest   # render dev/manifests/demo-vm.yaml for your host arch (amd64/arm64), then:"
echo "  ${CLI} create -f ${REPO_ROOT}/dev/manifests/demo-vm.yaml --wait   # demo VM"

...
IMAGE_URL="${IMAGE_URL:-https://cloud-images.ubuntu.com/minimal/releases/resolute/release/ubuntu-26.04-minimal-cloudimg-arm64.img}"  # Resolute (26.04) minimal arm64 cloudimg
ARCH="${ARCH:-arm64}"
IP1="10.71.0.10"
IP2="10.71.0.11"

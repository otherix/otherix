...
// and its children — create, get, list, delete. `create` is composite:
// it registers a template and, when --pool is provided, triggers a
...
func NewCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: `template groups the operator subcommands against the Control Plane's
/v1/templates surface — create, get, list, delete. The PATCH and

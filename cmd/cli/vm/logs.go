...
// logsState carries the flag values for `otherix vm logs`. Local to
// the package so other subcommand definitions cannot accidentally
// clobber the values.
var (
	logsTail   int
	logsFollow bool
...
`,
	...
	cmd.Flags().IntVar(&logsTail, "tail", -1,
...
func runLogs(cmd *cobra.Command, args []string) error {
	...
	reader, err := c.VMLogs(cmd.Context(), vmName, logsTail, logsFollow)
	if err != nil {

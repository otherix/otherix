...
// its target without committing a cutover.
func (h heartbeatProjection) MigrationTriedToLandOn(ctx context.Context, vmID, nodeID uuid.UUID) (bool, error) {
	return h.s.MigrationTriedToLandOn(ctx, vmID, nodeID)
}

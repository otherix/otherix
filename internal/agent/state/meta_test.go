...
func sampleMeta() *VMMeta {
	return &VMMeta{
		...
		PoolName:      "default",
		Architecture:  "arm64",
		DiskPath:      "/opt/otherix/pools/default/vms/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/disk.qcow2",
		QMPSocket:     "/opt/otherix/vms/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/qmp.sock",
		ConsoleSocket: "/opt/otherix/vms/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/console.sock",
		PIDFile:       "/opt/otherix/vms/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/qemu.pid",
		Status:        "running",

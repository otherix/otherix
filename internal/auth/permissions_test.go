...
func TestVMSSHPermissions(t *testing.T) {
	cases := []struct {
		...
		{auth.RoleAdmin, auth.PermVMIngressGrant, auth.ScopeAny},
		{auth.RoleOperator, auth.PermVMSSH, auth.ScopeAny},
		{auth.RoleOperator, auth.PermVMIngressGrant, auth.ScopeAny},
		{auth.RoleDeveloper, auth.PermVMSSH, auth.ScopeOwn},
		{auth.RoleDeveloper, auth.PermVMIngressGrant, auth.ScopeOwn},
		{auth.RoleViewer, auth.PermVMSSH, auth.ScopeNone},
		{auth.RoleViewer, auth.PermVMIngressGrant, auth.ScopeNone},
	}
	for _, c := range cases {
